...
function switchIdentity() {
    ...
    export ORDERER_CA=${PWD}/crypto-material/ordererOrganizations/pca.com/orderers/orderer.pca.com/msp/tlscacerts/tlsca.pca.com-cert.pem
    export CORE_PEER_LOCALMSPID=${ORG}MSP
    export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/crypto-material/peerOrganizations/${LOWER_MSP}.pca.com/peers/peer0.${LOWER_MSP}.pca.com/tls/ca.crt
    export CORE_PEER_MSPCONFIGPATH=${PWD}/crypto-material/peerOrganizations/${LOWER_MSP}.pca.com/users/Admin@${LOWER_MSP}.pca.com/msp
